import { c as renderElement, g as generateCspDigest, e as spreadAttributes, u as unescapeHTML, a as renderTemplate, f as removeBase, i as isRemotePath, h as unflatten, A as AstroError, U as UnknownContentCollectionError, o as object, j as date, k as array, R as RenderUndefinedEntryError, l as escape, n as string, p as prependForwardSlash, q as createHeadAndContent, r as renderComponent } from './prerender_2wk0_dQ0.mjs';
import { c as createComponent } from './Layout_CzMExyP2.mjs';
import 'clsx';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_vODxPbBw.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_CoVJ5DaK.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BoVjppY9.mjs');
