import { A as AstroError, I as InvalidComponentArgs, a as renderTemplate, r as renderComponent, t as renderSlot, v as renderHead, b as addAttribute, u as unescapeHTML } from './prerender_2wk0_dQ0.mjs';
import { jsxs, jsx } from 'react/jsx-runtime';
import { FileTextIcon, MailIcon, House } from 'lucide-react';
...
const Icons = {
  ...
  cv: (props) => /* @__PURE__ */ jsx(FileTextIcon, { ...props }),
...
const DATA = {
  ...
  url: "https://rahulvigneswaran.github.io",
  description: "AI Researcher & M.Tech. (By Research) student at IIT Hyderabad. Reliance Foundation Fellow.",
  ...
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/rahulvigneswaran",
        icon: Icons.github,
        navbar: true
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/rahulvigneswaran/",
        icon: Icons.linkedin,
        navbar: true
      },
      X: {
        name: "X",
        url: "https://x.com/rahulvigneswaran",
        icon: Icons.x,
        navbar: false
      },
      email: {
        name: "Send Email",
        url: "mailto:rahulvigneswaran@gmail.com",
        icon: Icons.email,
        navbar: false
      },
      CV: {
        name: "CV",
        url: "/Resume__2025_.pdf",
        icon: Icons.cv,
        navbar: true
      }
    }
...
function formatDate(date) {
  let currentDate = (/* @__PURE__ */ new Date()).getTime();
  if (!date.includes("T")) {
    date = `${date}T00:00:00`;
  }
  let targetDate = new Date(date).getTime();
  let timeDifference = Math.abs(currentDate - targetDate);
  let daysAgo = Math.floor(timeDifference / (1e3 * 60 * 60 * 24));
...
}, "/Users/rahulvigneswaran/Downloads/starfolio/src/layouts/Layout.astro", void 0);

export { $$Layout as $, Button as B, DATA as D, cn as a, createComponent as c, formatDate as f };
